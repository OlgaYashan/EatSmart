...
export default function* productsSaga() {
  yield all([takeLatest(actionTypes.LOAD_PRODUCTS, loadProducts),takeLatest(actionTypes.ADD_PRODUCT, addProduct),takeLatest(actionTypes.EDIT_PRODUCT, editProduct),takeLatest(actionTypes.DELETE_PRODUCT, deleteProduct)  ]);
}
